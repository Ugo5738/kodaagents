...
urlpatterns = [
    ...
    path('subscription-details/', views.SubscriptionDetailsView.as_view(), name='subscription_details'),
    path('billing-history/', views.SubscriptionDetailsView.as_view(), name='billing_history'),
    path('cancel-subscription/', views.SubscriptionDetailsView.as_view(), name='cancel_subscription'),
